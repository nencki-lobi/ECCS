...
setwd(osubdir)
saveWidget(as_widget(h), "Classification results for different threshold values.html") # HINT: Figure S3 in the manuscript
setwd('../../..')
...
write.csv(results_sliced, file = file.path(osubdir, "classification-results.csv"))
...
png(file.path(osubdir, "Visual representation of classes.png"), # HINT: Figure 4 in the manuscript
